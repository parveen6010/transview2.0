...
function VehicleRc({PropAuth}) {
  ...
  const [isChecked, setIsChecked] = useState(PropAuth);
  ...
  return (
    <div >
      ...
      >
        <div className="flex flex-col h-1/3 w-full px-10">
            <h3 className="text-xl font-bold text-green-500 mb-4 mt-4">Driver Information</h3>
            <div className="flex flex-col w-full justify-between">
                <div className="flex w-full justify-between">
                    <div>
                        <h3 className="text-xl text-center font-semibold">License Number</h3>
                        <p className="text-gray-400 font-semibold">XXXXX</p>
                    </div>
                    <div>
                        <h3 className="text-xl font-semibold">Driver Name</h3>
                        <p className="text-gray-400 font-semibold flex justify-end">XXXX</p>
                    </div>
                </div>
                <div className="flex w-full justify-between">
                    <div>
                    ...
                    <div>
                        <h3 className="font-semibold text-xl text-center">Date of Birth</h3>
                        <p className="text-gray-400 font-semibold flex justify-end">XXXX</p>
                    </div>
                </div>
                <div className="flex w-full justify-between">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 font-semibold flex justify-end">XXXXX</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="flex flex-col h-1/3 w-full justify-start px-10 ">
           <h3 className="text-xl font-bold text-green-500 mb-4 mt-4">Vehicle Information</h3>
           <div className="flex flex-col w-full justify-between">
            <div className="flex w-full justify-between">
                <div>
                ...
                <div>
                    <h3 className="font-semibold text-xl text-center">Owner Name</h3>
                    <p className="text-gray-400 font-semibold flex justify-end">XXXXX</p>
                </div>
            </div>
            <div className="flex w-full justify-between">
      ...
      />}
      <p>I/we consent the above Information is true</p>
    </div>
    ...
    <button
      type="submit"
      className={`border-2 ${
        isChecked ? "border-green-700 bg-green-700" : "border-green-300 bg-green-300"
      } text-white rounded-full px-12 py-2  inline-block font-semibold    `}
    //   onClick={PropAuth?GoToBill:AuthorizationFormgo }
       disabled={!isChecked}
    >
         {PropAuth?<div onClick={GoToBill}>Submit</div>:<div onClick={AuthorizationFormgo}>Authorize</div>}
