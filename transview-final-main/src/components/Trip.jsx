        ...
        <div className="flex h-content bg-gradient-to-tr from-white to-green-400 w-full gap-4 mt-16 ">
          ...
          <div className="bg-white w-1/2 ml-5 rounded-lg p-4 shadow-lg flex flex-col">
            ...
            <div className="flex w-full justify-around">
                <button className="bg-green-400 text-white rounded px-4 py-2" onClick={tostershow}> Send OTP</button>
                <button className="bg-green-400 text-white rounded px-4 py-2" onClick={goToAuth} >Verify</button>
            </div>
